...
{% file src="../../.gitbook/assets/[템플릿] 법령 검색 에이전트 (1).yml" %}

<table><thead><tr><th>앱 이름</th><th data-type="files">yml 파일</th><th data-type="files">첨부 파일</th><th></th></tr></thead><tbody><tr><td>법령 검색 에이전트</td><td><a href="../../.gitbook/assets/[템플릿] 법령 검색 에이전트.yml">[템플릿] 법령 검색 에이전트.yml</a></td><td></td><td></td></tr><tr><td>사내 규정 에이전트</td><td><a href="../../.gitbook/assets/[템플릿] 사내 규정 에이전트.yml">[템플릿] 사내 규정 에이전트.yml</a></td><td><a href="../../.gitbook/assets/[템플릿] GS 사내규정집.csv">[템플릿] GS 사내규정집.csv</a></td><td></td></tr><tr><td>뉴스 스크래핑 워크플로우</td><td><a href="../../.gitbook/assets/[템플릿]뉴스 스크래핑 워크플로우 (반복노드 버전).yml">[템플릿]뉴스 스크래핑 워크플로우 (반복노드 버전).yml</a></td><td></td><td></td></tr><tr><td>PDF 요약 분석</td><td><a href="../../.gitbook/assets/[템플릿] PDF 요약 분석.yml">[템플릿] PDF 요약 분석.yml</a></td><td><a href="../../.gitbook/assets/[템플릿] 산업보건법.pdf">[템플릿] 산업보건법.pdf</a></td><td></td></tr></tbody></table>
