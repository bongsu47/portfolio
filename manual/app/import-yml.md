...
YML 파일에는 에이전트와 워크플로우 앱 설정값이 포함됩니다. 파일을 MISO로 가져오면 앱이 생성됩니다.
{% endhint %}
...
기존 앱 메뉴에서 **앱 내보내기**를 통해 `.yml` 파일을 다운받습니다.

<figure><img src="../../.gitbook/assets/스크린샷 2026-09-14 123435.png" alt=""><figcaption></figcaption></figure>
{% endstep %}
